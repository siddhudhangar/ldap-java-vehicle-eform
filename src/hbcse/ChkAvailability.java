...
/**
 * Servlet implementation class ChkAvailability
 */
@WebServlet("/ChkAvailability")
public class ChkAvailability extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    Statement statement2=con1.createStatement();
			String sql ="SELECT  * from vehicle_form_data where Date='"+NewDate+"'";
			//System.out.println(NewDate);
			statement2.executeQuery(sql);
			ResultSet resultSet2=statement2.getResultSet();
			
			String MailContent1="<table id=myTable style='font-size:14px;border-collapse:collapse;' align=center cellpadding=3 cellspacing=2 border=1>"
			   		+"<tr bgcolor='#A2CBEF'>"
			   		+"<td><b>id</b></td>"
			   		+"<td><b>Full Name</b></td>"
